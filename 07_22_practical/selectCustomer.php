                    ...
                    <div class="row d-flex justify-content-center mt-5 rounded-2 bg-dark shadow text-bg-dark">
                        ...
                        <div class="col-8 p-5" id="costumerCard">
                            ...
                            <div class="row">
                                ...
                                <input class="col-4" name="firstName" id="firstName" value=<?= $entry["firstname"] ?> ></input>
                            </div>
                            <div class="row">
                                <label class="col-3" for="lastName">Last Name</label>
                                <input class="col-4" name="lastName" id="lastName" value=<?= $entry["lastname"] ?> ></input>
                            </div>
                            <div class="row">
                                <label class="col-3" for="email">Email</label>
                                <input class="col-4" name="email" id="email" value=<?= $entry["email"] ?> ></input>
                            </div>
                            <div class="row">
                                <label class="col-3" for="phoneNumber">Phone number</label>
                                <input class="col-4" name="phoneNumber" id="phoneNumber" value=<?= $entry["phone"] ?> ></input>
                            </div>
                            <div class="row">
                                <label class="col-3" for="comments">Comments</label>
                                <input class="col-4" name="comments" id="comments" value=<?= $entry["comments"] ?>></input>
                            </div>
